        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?= form_open('fleet/fleet_registration/form/') ?>
                    ...
                    <div class="form-group row">
                        <label for="total_seat" class="col-sm-3 col-form-label"><?php echo display('total_seat') ?></label>
                        <div class="col-sm-9">
                            <input name="total_seat" class="form-control" type="number" placeholder="<?php echo display('total_seat') ?>" id="total_seat" value="<?php echo $fleet_registration->total_seat ?>">
                        </div>
                    </div> 

                    <div class="form-group row">
                        <label for="seat_numbers" class="col-sm-3 col-form-label"><?php echo display('seat_numbers') ?></label>
                        <div class="col-sm-9">
                            <input name="seat_numbers" class="form-control tokenfield" type="text" id="seat_numbers" placeholder="<?php echo display('seat_numbers') ?>" value="<?php echo $fleet_registration->seat_numbers ?>">
...
$(document).ready(function() {
    $('#seat_numbers').tokenfield({showAutocompleteOnFocus: false});
