            ...
            <div class="container"> 
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                        <li><a href="<?php echo base_url('website') ?>"><i class="flaticon-discount"></i><?php echo display('search_tiket') ?></a></li>
                        <li><a href="#customer_service"><i class="flaticon-operator"></i><?php echo display('customer_service') ?></a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div>   
        </nav>
                    ...
                    <div class="col-sm-3">
                        <div class="footer_box">
                            ...
                            <?= form_open('ticket/feedback/form', array('id'=>'ratingFrm')) ?>
                                ...
                                <div class="form-group">
                                    <input name="tkt_booking_id_no" class="form-control" type="text" placeholder="<?php echo display('booking_id') ?>"  value="<?php echo $feedback->tkt_booking_id_no ?>">
                                </div> 
             
                                <div class="form-group">
                                    <input name="name" class="form-control" type="text" placeholder="<?php echo display('name') ?>" value="<?php echo $feedback->name ?>">
                                </div> 
                                ...
                                <div class="form-group">
                                    <textarea name="comment" placeholder="<?php echo display('comment') ?>" class="form-control"><?php echo $feedback->comment ?></textarea>
                                </div> 
