...
class Search extends MX_Controller {
    ...
    */
    ...
    public function booking()
    {
        ...
        $postData = array(
            ...
            'tkt_passenger_id_no'  => $this->randdomString("P"),
    ...
    */  
    ...
    public function findBookingInformation()
    {
        ...
        $rowSeat    = 1;
        $totalSeats = 1;
        $lastSeats  = ((sizeof($seatArray)>=5)?(sizeof($seatArray)-5):sizeof($seatArray));
        foreach ($seatArray as $seat) 
        {
	        ...
	        {
	        	//adding a cental row
	        	if ((sizeof($seatArray)&1) == 1 && ($lastSeats == 0 || $lastSeats < $totalSeats)) {
	        		continue;
		        } else {
